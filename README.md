...
# synopsis
 ...
 width="400" 
 height="200">
<br>AutoPPT is a simple mudule that helps for display the data into some repeated and unifed format. Users are only required to provide the design template, and than the repeated routine can be simply handel by python codes.</br>
## Requirement：</br>
